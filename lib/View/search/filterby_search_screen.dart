...
class FilterBySearchContainer extends StatefulWidget {
  const FilterBySearchContainer({super.key});

  @override
  State<FilterBySearchContainer> createState() => _FilterBySearchContainer();
}

class _FilterBySearchContainer extends State<FilterBySearchContainer> {
  @override
