...
class HairDryerScreen extends StatefulWidget {
  const HairDryerScreen({super.key});

  @override
  State<HairDryerScreen> createState() => _HairDryerScreenState();
}

class _HairDryerScreenState extends State<HairDryerScreen> {
        ...
        child: Column(
          children: [
            SizedBox(
                height: 139.17.h,
                width: 429.14.w,
                child: Image.asset(khairdyerImage)),
            SizedBox(
              height: 34.h,
            ),
            Align(
