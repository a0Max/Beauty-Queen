...
class FilterByNewArrivedContainer extends StatefulWidget {
  const FilterByNewArrivedContainer({super.key});

  @override
  State<FilterByNewArrivedContainer> createState() =>
      _FilterByNewArrivedContainer();
}

class _FilterByNewArrivedContainer extends State<FilterByNewArrivedContainer> {
  @override
