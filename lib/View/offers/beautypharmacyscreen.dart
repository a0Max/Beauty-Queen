          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                if ( controller
                    .generalSearchData2.value.info?.banner != null)
                  SizedBox(
                      height: 139.17.h,
                      ...
                      child: CachedNetworkImage(
                          imageUrl: Connection.urlOfStorage(
                              image: controller
                                  .generalSearchData2.value.info?.banner ??
                                  ''))),
                ...
                ...List.generate(
                    controller.generalSearchData2.value.offers?.data?.length ?? 0,
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    controller.generalSearchData2.value
                                  ...
                                  InkWell(
                                    ...
                                    BorderRadius.circular(
                                        10.69.r),
                                    onTap: (){
                                      Get.to(ItemProfilePage(itemId: controller
                                          .generalSearchData2
                                          .value
                                          .offers?.data?[index].id??0));
