              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  children: List.generate(
                    _controller.categoryData.value.where((element) => element.id == widget.categoryId).toList().first.children.length,
                    (index) => Padding(
                      padding: EdgeInsets.only(right: 8.82.w),
                      child: Obx(
                        () => MyCustomContainer(
                          text: _controller.categoryData.value.where((element) => element.id == widget.categoryId).toList().first.children[index].title,
                          isSelected:
                          _controller.categoryData.value.where((element) => element.id == widget.categoryId).toList().first.children[index].id == _controller.currentCategoryId.value,
                          onTap: () {
                            _controller.updateCurrentCategoryId(newId:_controller.categoryData.value.where((element) => element.id == widget.categoryId).toList().first.children[index].id??0, getChild: true);
                          },
                        ),
                      ),
                    ),
                ...
                child: Row(
                  children: List.generate(
                    _controller.childCategoryData.length,
                      ...
                      child: Obx(
                            () => MyCustomContainer(
                          text: _controller.childCategoryData.value[index].title,
                          isSelected:
                          _controller.childCategoryData.value[index].id == _controller.childCurrentCategoryId.value,
                          onTap: () {
                            _controller.updateChildCurrentCategoryId(newId:_controller.childCategoryData.value[index].id??0);
                          },
                        ),
                      ),
                    ),
