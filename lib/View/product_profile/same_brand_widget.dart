...
class SameBrandWidget extends StatefulWidget {
  final List data;

  const SameBrandWidget({super.key, required this.data});
  @override
  State<StatefulWidget> createState() {
    return _SameBrandWidget();
  }
}

class _SameBrandWidget extends State<SameBrandWidget> {
  @override
  void initState() {
    super.initState();
    _startAddingItems();
