                  ...
                  children: [
                        ...
                        Row(
                          children: [
                            GestureDetector(
                              ...
                              child: Badge(
                                  label: Text((_controllerNav.countCart.value)
                                      .toString()),
                                  isLabelVisible:
                                      ((_controllerNav.countCart.value) != 0),
                                  child: SvgPicture.asset(
                                    AppImages.imageShop,
                                    height: 30.h,
                                    width: 30.w,
                    ...
                    Container(
                        ...
                        child: Column(children: [
                                                            ...
                                                            Container(
                                                                ...
                                                                decoration:
                                                                  ...
                                                                  image: DecorationImage(
                                                                      image: CachedNetworkImageProvider(Connection.urlOfOptions(
                                                                          image:
                                                                              value.mainImage?.file ?? ''))),
                                                                )),
                                                            Padding(
                                                              padding:
                                                                  EdgeInsets
                          ...
                          SizedBox(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: (controller.productData.isNotEmpty ??
                                          false)
                          ...
                          DetailsStatic(
                            title: tr('Free_gifts_and_samples_with_your_order'),
                            body: tr('Free_gifts_and_samples_with_your_order2'),
                          ...
                          (controller.productData.isNotEmpty ?? false)
                              ? GestureDetector(
                                  onTap: () {
                                    List text = controller.productData.last
                                        .product_banner.bannerUrlLink
                                        .toString()
                                        .split('/');
                                    print('text:$text');
                                    ...
                                    controller000.updateCurrentCategoryId(
                                        newId: int.parse("${text[2]}"),
                                        getChild: null,
                                        subId: int.parse("${text.last}"));
                                    Get.to(FliterScreen2(
                                      categoryId: int.parse(text[2].toString()),
                                    ));
                                    // }
                                  },
                    ...
                    if (widget.isQueenOffer != true) ...{
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            if (controller.productData.isNotEmpty &&
                                controller.productData.last.offers != null &&
                              ...
                              CarouselSlider(
                                ...
                                items: List.generate(
                                    controller
                                            .productData.last.offers?.length ??
                                        0,
                ...
                children: [
                  ...
                  if (controller.isLoading != true) ...{
                    if ((controller.productData.isNotEmpty == true) &&
                        (controller.productData.last.product.stock == null ||
