...
class CustomCardWidget2 extends StatefulWidget {
  ...
  @override
  State<CustomCardWidget2> createState() => _CustomCardWidgetState();
}

class _CustomCardWidgetState extends State<CustomCardWidget2> {
